...
// const Review = require(`${modelsPath}/Review`);
...
// const fileDataReviews = fs.readFileSync(`${__dirname}/reviews.json`, "utf-8");
...
// const productReviews = JSON.parse(fileDataReviews);
...
const importData = async () => {
  try {
    ...
    // await Review.create(productReviews);
