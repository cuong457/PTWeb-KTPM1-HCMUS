...
})(
  {
    ...
    "user/uc-handle.js": [
      function (require, module, exports) {
        ...
        function renderUC() {
          ...
          var typeS =
            arguments.length > 3 && arguments[3] !== undefined
              ...
              : "none";
          fetch(
            "http://localhost:3000/admin/usercenter/get-users-data?page=" +
              page +
              "&sort=" +
              sortQ +
              "&search=" +
        ...
        function handleSelectType(e) {
          ...
          document.getElementById("user-typesearch-btn").dataset.type =
            target_key;
        }
        function handleSearch(e) {
          key_srch = document.getElementById("user-search-box").value.trim();
          type_srch = document.getElementById("user-typesearch-btn").dataset
            .type;
        ...
        function banUser() {
          ...
          var type =
            arguments.length > 1 && arguments[1] !== undefined
              ...
              : "none";
          fetch(
            "http://localhost:3000/admin/usercenter/ban-user?id=" +
              id +
              "&type=" +
              type
          )
    ...
    "user/products-handle.js": [
      function (require, module, exports) {
        ...
        function renderPC() {
          ...
          var typeS =
            arguments.length > 3 && arguments[3] !== undefined
              ...
              : "none";
          fetch(
            "http://localhost:3000/admin/products/get-products-data?page=" +
              page +
              "&sort=" +
              sortQ +
              "&search=" +
            ...
            .then(function (data) {
              ...
              var numpage_btn = document.querySelectorAll(
        ...
        function handleSelectTypeProducts(e) {
          ...
          document.getElementById("products-typesearch-btn").dataset.type =
            target_key;
        }
        function handleSearchProducts(e) {
          key_srch = document
            .getElementById("products-search-box")
            .value.trim();
          type_srch = document.getElementById("products-typesearch-btn").dataset
            .type;
          if (key_srch !== "" && type_srch != "none") {
        ...
        function handleFilterProducts(e) {
          ...
          if (!$(cur_target).hasClass("filter-btn-active")) {
            ...
            var filterBtnList = document.querySelectorAll(
              ".products-filter-btn"
            );
            if (filterBtnList) {
              filterBtnList.forEach(function (btn) {
            ...
            $(cur_target).removeClass("filter-btn-active");
            // Get option
            var _filterBtnList = document.querySelectorAll(
              ".products-filter-btn"
            );
            if (_filterBtnList) {
              _filterBtnList.forEach(function (btn) {
    ...
    "user/orders-handle.js": [
      function (require, module, exports) {
        ...
        function _updateOrderStatus() {
          _updateOrderStatus = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(e) {
        ...
        function handleFilterOrders(e) {
          ...
          var isSelectElement = cur_target.classList.contains(
          ...
          if (!$(cur_target).hasClass("filter-btn-active")) {
            ...
            // Get option
            var _filterBtnList =
              document.querySelectorAll(".orders-filter-btn");
            if (_filterBtnList) {
              _filterBtnList.forEach(function (btn) {
                if ($("#" + btn.id).hasClass("filter-btn-active")) {
                  option += "-" + btn.id.split("-")[1];
    ...
    "payment/cart.js": [
      function (require, module, exports) {
        ...
        exports.handleSetItemQuantity =
          exports.handleDeleteItemFromCart =
          exports.handleCartToOrder =
          exports.handleAddItemToCart =
            void 0;
        function _typeof(obj) {
          "@babel/helpers - typeof";
          return (
                  ...
                  while (1) {
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        ...
                        cartQuantity = document.querySelector(
                          ".cart-icon__quantity"
                        );
                    ...
                    switch ((_context2.prev = _context2.next)) {
                      ...
                      case 16:
                        ...
                        formattedSubTotal = subTotal
                          .toString()
                          .replace(/\B(?=(\d{3})+(?!\d))/g, ".");
                        cartTotals[0].textContent = "".concat(
                          formattedSubTotal,
                          " VN\u0110"
                        );
                        cartTotals[1].textContent = "".concat(
                          formattedSubTotal,
                          " VN\u0110"
                        );
                        _context2.next = 26;
                  ...
                  while (1) {
                    switch ((_context4.prev = _context4.next)) {
                      case 0:
                        ...
                        lengthItems = _toConsumableArray(
                        ...
                        alert(
                          "cannot find productId, fail to delete item from cart"
                        );
                      ...
                      case 20:
                        ...
                        if (data.status === "success") {
                          ...
                          formattedSubTotal = subTotal
                            .toString()
                            .replace(/\B(?=(\d{3})+(?!\d))/g, "."); // update user interface
    ...
    "product/filter.js": [
      function (require, module, exports) {
        ...
        exports.loadFilterFromSearchParams =
          exports.handleSearchAndFilter =
          exports.handlePagination =
            void 0;
        ...
        function loadProductPage(query) {
          fetch("/api/v1/products".concat(query))
            .then(function (response) {
              return response.json();
            })
            .then(function (data) {
              ...
              var links = Array.from(
                Array(
                  pagination_info.last_page - pagination_info.first_page + 1
                )
              ).map(function (_, idx) {
                return {
                  pageNumber: idx + pagination_info.first_page,
                  selected:
                    idx + pagination_info.first_page ===
        ...
        var handleSearchAndFilter = function handleSearchAndFilter(e) {
          ...
          // 1.price search
          var fromInput = document.querySelector(
          ...
          // 3.manufacturer
          var checkedManufacturerInputs = _toConsumableArray(
          ...
          // 0) search
          var searchQuery =
            boxSearch.value !== "" ? "?_search=".concat(boxSearch.value) : "?";
          // 1) price search
          ...
          if (checkedManufacturerInputs.length !== 0) {
            var manufacturers = checkedManufacturerInputs.map(function (
              checkedManu
            ) {
        ...
        var loadFilterFromSearchParams = function loadFilterFromSearchParams() {
          ...
          if (params.has("column") && params.has("type")) {
            ...
            var sortOptions = document.querySelector(
              "input[value=".concat(sortValue, "]")
            );
          ...
          if (params.has("page")) {
            var page = document.querySelector(
              '.page-item[value="'.concat(params.get("page"), '"]')
            );
    ...
    "index.js": [
      function (require, module, exports) {
        ...
        // Admin handling
        var clearSearchboxUser = document.getElementById(
          "user-clearsearch-btn"
        );
        if (clearSearchboxUser) {
          clearSearchboxUser.addEventListener(
            "click",
            _ucHandle.handleClearSearchboxUser
          );
        }
        ...
        // Product handling
        var clearSearchboxProducts = document.getElementById(
          "products-clearsearch-btn"
        );
        if (clearSearchboxProducts) {
          clearSearchboxProducts.addEventListener(
            "click",
            _productsHandle.handleClearSearchboxProducts
          );
        }
        var productsSearchBtn = document.getElementById(
          "products-search-button"
        );
        if (productsSearchBtn) {
          productsSearchBtn.addEventListener(
            "click",
            _productsHandle.handleSearchProducts
          );
        }
        var productsFilterBtn = document.querySelectorAll(
          ".products-filter-btn"
        );
          ...
          document
            ...
            .forEach(function (btn) {
              btn.addEventListener(
                "click",
                _productsHandle.handleFilterProducts
              );
            });
        }
        ...
        if (productsTypeBtn) {
          productsTypeBtn.forEach(function (btn) {
            btn.addEventListener(
              "click",
              _productsHandle.handleSelectTypeProducts
            );
          });
        }
        ...
        if (productsFilterOrderBtn.length > 0) {
          ...
          var productsFilterOrderSelect = document.querySelector(
            ".orders-status-filter"
          );
          productsFilterOrderSelect.addEventListener(
            "change",
            _ordersHandle.handleFilterOrders
          );
        }
        ...
        var quantityCartBtn = _toConsumableArray(
          document.querySelectorAll("input[name='quantity']")
        );
        var deleteItemBtn = _toConsumableArray(
        ...
        if (filterSortBtn) {
          // check manufacturer
          var checkedManufacturerWrappers = _toConsumableArray(
          ...
          filterSortBtn.addEventListener(
            "click",
            _filter.handleSearchAndFilter
          );
        }
          ...
          inputBoxSearch.on("keypress", function (e) {
            if (e.which == 13) {
              if (inputBoxSearch.val()) {
                var _url = (0, _filter.createUrl)(
                  "_search",
                  inputBoxSearch.val()
                );
                if (location.pathname !== "/products") {
                  location.href = "/products?_search=".concat(
                    inputBoxSearch.val()
                  );
                } else {
      ...
      {
        "./auth/sign-out.js": "auth/sign-out.js",
        "./user/uc-handle.js": "user/uc-handle.js",
        "./user/products-handle.js": "user/products-handle.js",
        "./user/orders-handle.js": "user/orders-handle.js",
        "./payment/cart.js": "payment/cart.js",
        "./product/filter.js": "product/filter.js",
        "./payment/order.js": "payment/order.js",
      },
    ],
